...
//モデルデータの指定
#define MODEL_OBJ "res\\MapDate.csv","res\\Test.csv"
...
void CSceneGame::Init()
{
	...
	//エフェクトの画像読み込み
	CEffect::LoadTexture("res\\exp.tga");
	//サウンド(wav)ファイルの読み込み
	Bgm.Load("res\\map.wav");
	Se.Load("res\\enemy.wav");
	PlayerSe.Load("res\\player.wav");
	ShotSe.Load("res\\shot.wav");
	ItemSe.Load("res\\item.wav");
	//サウンドファイルの繰り返し再生
	Bgm.Repeat();
	//シーンの設定
	mScene = EGAME;
