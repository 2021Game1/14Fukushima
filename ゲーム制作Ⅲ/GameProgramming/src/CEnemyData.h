...
//敵の下半身
#define ENEMY_COLSPHERE_LOWERBODY_X 0.0f			//球コライダのX座標設定
#define ENEMY_COLSPHERE_LOWERBODY_Y 15.5f			//球コライダのY座標設定
#define ENEMY_COLSPHERE_LOWERBODY_Z 0.0f			//球コライダのZ座標設定
#define ENEMY_COLSPHERE_LOWERBODY_SIZE 0.5f			//球コライダのサイズ設定
