...
CMatrix CMatrix::operator+(const CMatrix& m) {
	CMatrix t;
	t.mM[0][0] = m.mM[0][0] + mM[0][0];
	t.mM[0][1] = m.mM[0][1] + mM[0][1];
	t.mM[0][2] = m.mM[0][2] + mM[0][2];
	t.mM[0][3] = m.mM[0][3] + mM[0][3];

	t.mM[1][0] = m.mM[1][0] + mM[1][0];
	t.mM[1][1] = m.mM[1][1] + mM[1][1];
	t.mM[1][2] = m.mM[1][2] + mM[1][2];
	t.mM[1][3] = m.mM[1][3] + mM[1][3];

	t.mM[2][0] = m.mM[2][0] + mM[2][0];
	t.mM[2][1] = m.mM[2][1] + mM[2][1];
	t.mM[2][2] = m.mM[2][2] + mM[2][2];
	t.mM[2][3] = m.mM[2][3] + mM[2][3];
